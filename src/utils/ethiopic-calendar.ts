 ...
 */
export function ethCopticToJDN(year: number, month: number, day: number, era: number): number {
 ...
 * @return {Number}
 */
export function jdnToGregorian(jdn: number, JD_OFFSET = JD_EPOCH_OFFSET_GREGORIAN, leapYear = isGregorianLeap): EcDate {
  const nMonths = 12;
 ...
 * @return {Number}
 */
export function guessEra(jdn: number, JD_AM = JD_EPOCH_OFFSET_AMETE_MIHRET, JD_AA = JD_EPOCH_OFFSET_AMETE_ALEM): number {
 ...
 * @return {Number}
 */
export function gregorianToJDN(year = 1, month = 1, day = 1, JD_OFFSET = JD_EPOCH_OFFSET_GREGORIAN) : number{
 ...
 */
export function jdnToEthiopic(jdn: number, era = JD_EPOCH_OFFSET_AMETE_MIHRET): EcDate {
...
export function ethiopicToGregorian(year = 1, month = 1, day = 1, era = JD_EPOCH_OFFSET_AMETE_MIHRET): EcDate {
  return jdnToGregorian(ethCopticToJDN(year, month, day, era));
}

export function gregorianToEthiopic(year = 1, month = 1, day = 1): EcDate {
